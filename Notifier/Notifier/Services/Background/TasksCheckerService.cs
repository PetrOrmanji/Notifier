...
{
    private const string LongLineSeparator = "------------------------------";
        ...
        ILogger<TasksCheckerService> logger)
    {
        ...
        _lastCheckDateTime = DateTime.UtcNow.AddMinutes(-30);
    }
    ...
    private TelegramNotificationDto[] HandleMessages(ImapMessageDto[] msgs)
    {
        ...
        foreach (var msg in msgs)
        {
            ...
            var firstSeparatorIndex = Array.FindIndex(msgLines, x => x.Trim().StartsWith(LongLineSeparator));
